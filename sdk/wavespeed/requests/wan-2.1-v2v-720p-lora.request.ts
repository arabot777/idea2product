...
const Wan21V2v720pLoraSchema = z.object({
  ...
  loras: z.array(LoraWeightSchema).max(3).default([{ path: "motimalu/wan-flat-color-v2", scale: 1 }]).optional().describe('The LoRA weights for generating the output.'),
...
export class Wan21V2v720pLoraRequest extends BaseRequest<typeof Wan21V2v720pLoraSchema> {
  ...
  protected data: z.infer<typeof Wan21V2v720pLoraSchema>;
  ...
  static static getDefaultParams(): Record<string,any> {
    return {
      duration: 5,

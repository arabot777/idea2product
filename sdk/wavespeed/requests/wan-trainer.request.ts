...
const WanTrainerSchema = z.object({
  ...
  learning_rate: z.number().min(1e-06).max(1).default(0.0002).describe('The rate at which the model learns. Higher values can lead to faster training, but over-fitting.').optional(),
